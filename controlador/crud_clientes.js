...
crud_cliente.leer = (req,res)=>{
    //SELECT clientes.id_cliente,clientes.nit,clientes.nombres,clientes.apellidos,clientes.direccion,clientes.telefono, DATE_FORMAT(clientes.fecha_nacimiento,"%d-%m-%y") as fecha_nacimiento FROM clientes;
